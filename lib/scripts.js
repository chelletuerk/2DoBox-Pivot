...
$('#critical').click(e => {
helpers.emptyIdeas();
ideas.findCriticalIdeas().forEach((e) => {
  $('ideas').prepend(createCard(e))
  })
});
...
$('#normal').click(e => {
helpers.emptyIdeas();
ideas.findNormalIdeas().forEach((e) => {
  $('ideas').prepend(createCard(e))
  })
});
